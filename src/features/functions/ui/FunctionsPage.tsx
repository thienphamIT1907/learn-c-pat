...
import { functionsContent } from "../content/functions.content";

export function FunctionsPage() {
  const { explanation, codeExample, diagram, faq } = functionsContent;
  return (
    <div className="flex flex-col gap-8 p-8 max-w-3xl">
      <h1 className="text-2xl font-semibold tracking-tight">Hàm</h1>
