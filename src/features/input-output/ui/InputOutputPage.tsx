...
import { inputOutputContent } from "../content/input-output.content";

export function InputOutputPage() {
  const { explanation, codeExample, diagram, faq } = inputOutputContent;
  return (
    <div className="flex flex-col gap-8 p-8 max-w-3xl">
      <h1 className="text-2xl font-semibold tracking-tight">Nhập &amp; Xuất dữ liệu</h1>
