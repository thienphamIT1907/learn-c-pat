...
import { arraysContent } from "../content/arrays.content";

export function ArraysPage() {
  const { explanation, codeExample, diagram, faq } = arraysContent;
  return (
    <div className="flex flex-col gap-8 p-8 max-w-3xl">
      <h1 className="text-2xl font-semibold tracking-tight">Mảng</h1>
