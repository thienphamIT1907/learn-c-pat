...
import { dataTypesContent } from "../content/data-types.content";

export function DataTypesPage() {
  const { explanation, codeExample, diagram, faq } = dataTypesContent;
  return (
    <div className="flex flex-col gap-8 p-8 max-w-3xl">
      <h1 className="text-2xl font-semibold tracking-tight">Kiểu dữ liệu</h1>
