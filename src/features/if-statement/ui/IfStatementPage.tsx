...
import { ifStatementContent } from "../content/if-statement.content";

export function IfStatementPage() {
  const { explanation, codeExample, diagram, faq } = ifStatementContent;
  return (
    <div className="flex flex-col gap-8 p-8 max-w-3xl">
      <h1 className="text-2xl font-semibold tracking-tight">Câu lệnh If</h1>
