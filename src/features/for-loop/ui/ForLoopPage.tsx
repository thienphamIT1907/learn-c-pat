...
import { forLoopContent } from "../content/for-loop.content";

export function ForLoopPage() {
  const { explanation, codeExample, diagram, faq } = forLoopContent;
  return (
    <div className="flex flex-col gap-8 p-8 max-w-3xl">
      <h1 className="text-2xl font-semibold tracking-tight">Vòng lặp For</h1>
