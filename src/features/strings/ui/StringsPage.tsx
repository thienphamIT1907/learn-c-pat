...
import { stringsContent } from "../content/strings.content";

export function StringsPage() {
  const { explanation, codeExample, diagram, faq } = stringsContent;
  return (
    <div className="flex flex-col gap-8 p-8 max-w-3xl">
      <h1 className="text-2xl font-semibold tracking-tight">Chuỗi ký tự</h1>
